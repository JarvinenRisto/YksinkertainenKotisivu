<?php
	...
	header("Content-Security-Policy: default-src 'self'; script-src 'self' 'unsafe-inline' https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/; img-src 'self' https://www.gstatic.com/recaptcha/; style-src 'self' 'unsafe-inline'; frame-src https://www.google.com/recaptcha/;");
...
<p>Huomio: 20 sekunnin odotusaika onnistuneen viestin lähetyksen jälkeen, joten suositus on että viesti mietitty. Minimi merkkiraja 8 ja max 4000 viestissä, nimessä max merkkiraja 100.</p>
<p>Lomakkeen lähetys vaatii evästeet. Salli vähintään tämän sivuston omat evästeet.</p>
