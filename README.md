...
POST pyyntöraja onnistuneen captchan jälkeen, 60 pyyntöä per ip / per minuutti, jossa ylittävät 1 min sisällä merkataan spämmiksi, jossa huonoa voi olla jos jaetussa verkossa samaan aikaan lähetetään lomake että raja tulee vastaan. Oikeilla yrityissivuilla voi todennäköisesti olla käytössä jonkin sortin palomuuri, ja/tai esimerkiksi Cloudflare.
