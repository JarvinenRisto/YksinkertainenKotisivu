...
POST pyyntöraja onnistuneen captchan jälkeen, 30 pyyntöä per ip / per minuutti, jonka jälkeen viesti merkataan spämmiksi, jossa huonoa voi olla jos jaetussa verkossa samaan aikaan lähetetään lomake että raja tulee vastaan. Oikeilla yrityissivuilla voi todennäköisesti olla käytössä jonkin sortin palomuuri.
