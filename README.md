...
POST pyyntöraja onnistuneen captchan jälkeen, 10 pyyntöä per ip / per minuutti ja tuohon yhdistettynä roskainen user-agent, jossa rajan ylittävät 1 min sisällä merkataan spämmiksi. Oikeilla yrityissivuilla voi todennäköisesti olla käytössä jonkin sortin palomuuri, ja/tai esimerkiksi Cloudflare.
