...
Jos käyttäjä lähetti lomakkeen nopeammin kuin 3 sekunnissa, lähetys estyy, $SESSION avulla toteutettu. Onko POST pyyntö laitettu sivujen lomakkeen kautta tarkistus, $SESSION tässäkin. $SESSION kohtainen 10 sekunnin viive edellisestä onnistuneesta käyttäjän lomakkeen lähetyksestä (voi tuntua huonolta jos lähettäjän tarvitsee muokata edellistä viestiä). CSRF tarkistus.
