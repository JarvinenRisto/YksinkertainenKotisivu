...
POST pyyntöraja onnistuneen captchan jälkeen, 20 pyyntöä per ip / per minuutti ja lisätunnistus tuossa roskainen user-agent, jossa rajan ylittävät 1 min sisällä merkataan spämmiksi. Oikeilla yrityissivuilla voi todennäköisesti olla käytössä jonkin sortin palomuuri, ja/tai esimerkiksi Cloudflare.
