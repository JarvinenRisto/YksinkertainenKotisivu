...
POST pyyntöraja, 10 pyyntöä per ip / per minuutti tässä versiossa. Onko sama viesti md5 tarkistus, jos on merkitään meneväksi spam laatikkoon admin sivulle, josta voi lähettää/lukea/poistaa. Onko POST pyyntö laitettu sivujen lomakkeen kautta tarkistus, $SESSION avulla toteutettu. CSRF tarkistus. Lomakeviestin minimipituus 8 merkkiä, max pituus 4000..
