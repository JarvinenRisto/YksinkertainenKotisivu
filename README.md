...
Roskainen UserAgent tunnistus yhdistettynä POST pyyntörajoitukseen: 10 pyyntöä per ip / per minuutti, jossa rajan ylittävät 1 min sisällä merkataan spämmiksi. Oikeilla yrityissivuilla voi todennäköisesti olla käytössä jonkin sortin palomuuri, ja/tai esimerkiksi Cloudflare.
